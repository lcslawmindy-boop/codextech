...
const TIERS = [
  ...
  },
  {
    ...
    headline: "Everything — courses & builds at 50% off",
    description: "All 40+ courses · 50% off all builds & kits · Full AI suite",
    cta: "Get All Access — $150/mo",
    ctaSub: "Best value · Cancel anytime",
    popular: true,
    features: [
      "All 40+ courses — full curriculum access",
      "50% off all 40+ build plans (BOM, schematics, assembly)",
      "50% off all physical hardware kits",
      "Full AI suite: Patent drafting, FTO, Claims",
      "200+ Prior Art Research Archive",
