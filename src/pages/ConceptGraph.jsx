  ...
  return (
    <div className="w-screen h-screen bg-gray-950 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-4 py-2 overflow-x-auto border-t border-gray-800/60" style={{scrollbarWidth: 'thin'}}>
          ...
          <Link to="/trz-patent" className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-red-900/60 hover:bg-red-800/60 border border-red-700 text-red-200 text-xs font-bold transition-colors">📋 TRZ Patent PPA</Link>
          <Link to="/valuation" className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-yellow-900/60 hover:bg-yellow-800/60 border border-yellow-600 text-yellow-200 text-xs font-bold transition-colors">📈 Valuation Dashboard</Link>
