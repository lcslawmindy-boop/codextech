...
const TIERS = [
  {
    ...
    color: "#10b981",
    badge: null,
    description: "Courses & discounted plans",
    features: [
      "Access to 20+ courses",
      "25% off all build plans & à la carte purchases",
  ...
  },
  {
    ...
    color: "#3b82f6",
    badge: "MOST POPULAR",
    description: "Full courses, AI tools & deep IP analysis",
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      "ALL AI tools (Forge, Patent Drafting, FTO, etc.)",
      "Investor CRM & Pitch Builder",
      "Virtual Data Room (VDR) with document sharing",
      "IP Portfolio Health Dashboard",
      "Co-Inventor Matching Network",
      "SBIR Grant Pipeline",
      "Patent Intelligence Monitor",
