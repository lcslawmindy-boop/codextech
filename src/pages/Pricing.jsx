...
const SUBSCRIPTION_TIERS = [
  {
    ...
    color: "#6366f1",
    badge: "MOST POPULAR",
    description: "All plans + AI tools + course library + 50% off purchases",
    features: [
      ...
      "50% off individual courses & invention plans",
      "Cancel anytime",
    ],
  ...
  },
  {
    ...
    price: 247,
    color: "#22c55e",
    description: "Everything + IP suite + investor tools + 75% off purchases",
    features: [
      ...
      "75% off individual courses & invention plans",
      "Priority support",
      "Cancel anytime",
    ],
    locked: [],
