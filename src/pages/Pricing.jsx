...
const SUBSCRIPTION_TIERS = [
  {
    ...
    color: "#6366f1",
    badge: "MOST POPULAR",
    description: "3 invention plans + 3 courses + 50% off other purchases",
    features: [
      "3 Invention Build Plans (full PDFs + BOMs)",
  ...
  },
  {
    ...
    price: 247,
    color: "#22c55e",
    description: "6 invention plans + 6 courses + 75% off other purchases",
    features: [
      "6 Invention Build Plans (full PDFs + BOMs)",
      ...
      "75% off additional plans & courses",
      "Priority support",
      "Cancel anytime",
    ],
    locked: [],
