...
const items = [
  ...
  // ── GRAVITOBIOLOGY INVENTIONS ──────────────────────────────────────────────
  {
    ...
    description:
      "Based on Bearden's 'fireflies effect' (Gravitobiology Fig 14): quantum potential EM interference appears as statistically anomalous noise bursts in sensitive detectors — invisible to classical EM instruments. This device uses a tuned quartz-crystal array with statistical burst-pattern analysis firmware to detect Whittaker-structured quantum potential signals. Investor angle: DoD/DARPA has documented anomalous EMI in Pentagon studies (Gravitobiology Table 7). This fills a sensor gap acknowledged in military literature.",
    modules: [],
    source: "Bearden Gravitobiology 1991: Table 6 (real-time anomalous EMI via QP), Figure 14 (fireflies effect), Table 7 (Pentagon EMI studies)",
    color: "#ef4444",
    icon: "📡",
  },
  {
    ...
    description:
      "Bearden's Gravitobiology (Table 12, p.41) documents specific EM frequency 'trigger windows' at which fields couple maximally to biological tissue — windows identified by Beck, Hunt, Lisitsyn, and Soviet researchers. This programmable frequency generator delivers precisely tuned EM pulses within verified trigger windows for therapeutic applications. Consumer version: wearable wristband. Clinical version: full-body exposure chamber. Revenue streams: device sales, clinical licensing, subscription app, research partnerships.",
    modules: [],
  ...
  },
  {
    ...
    description:
      "Based on Gravitobiology p.45-48: the morphogenetic field is a real Whittaker-structured quantum potential field guiding cellular development. Disruption causes cancer and developmental disorders ('internal EM pollution'). This instrument monitors the coherence of the local graviton lattice / quantum potential field around a biological sample — a crop, cell culture, or organism — providing a real-time 'morphogenetic coherence index.' Agriculture application: optimize growing conditions by monitoring field coherence. Medical application: early cancer detection via morphogenetic disruption signatures.",
    modules: [],
    source: "Gravitobiology p.45-48 (morphogenetic field), p.48 (EM pollution / cancer mechanism), Figure 20 (graviton lattice)",
    color: "#22c55e",
    icon: "🌿",
  },
  {
    ...
    tagline: "Time-reverse EM signals — the basis of scalar EM healing and communications",
    price: "$8,500 prototype / $450 engineering plans",
    audience: "Defense R&D, advanced physics labs, scalar communications startups",
    description:
      "Gravitobiology Figure 10-11 documents ordinary vs. phase conjugate mirror reflection and the pumped phase conjugate mirror (PPCM). A PPCM time-reverses an incoming EM wave — the output is an exact phase-conjugate replica traveling back to the source. Applications: (1) communications — self-targeting, source-finding signal return; (2) healing — time-reversing the Whittaker EM structure of a disease pattern cancels it at the quantum potential level; (3) weapons countermeasures — time-reversing an incoming EM BW signal. Highest investor-interest application: scalar communications immune to interception.",
    modules: [],
    source: "Gravitobiology Figures 10, 11 (phase conjugate mirrors); Whittaker wave decomposition of EM potential",
    color: "#3b82f6",
    icon: "🔭",
  },
  {
    ...
    description:
      "A comprehensive course on Bearden's 1991 Gravitobiology synthesis. Covers: graviton structure (coupled photon/antiphoton spin-2 pairs), Whittaker standing potential waves, quantum potential as non-local EM carrier, Soviet Woodpecker signals decoded as EM BW delivery systems, EM trigger windows for disease induction, the fireflies effect, morphogenetic field mechanism, Earth/Sun/Moon Whittaker coupling, and gravitobiological mechanisms for the drug epidemic, cancer, and evolution. Includes annotated reproductions of all 25 original figures and 12 tables.",
    modules: [
    ...
    source: "Bearden Gravitobiology (1991/2019 Energetic Productions); full 60-page paper with 25 figures and 12 tables",
    color: "#a855f7",
    icon: "🧫",
  },
  {
    ...
    description:
      "A fully annotated edition of Bearden's Gravitobiology with three layers: (1) the original text and all 25 figures/12 tables; (2) plain-English commentary explaining each concept; (3) a 'business application' sidebar on every major section identifying commercial opportunities — from EM trigger window therapeutics to quantum potential sensors to morphogenetic agriculture. Final chapter: 10 investor-ready business models derived directly from Gravitobiology.",
    modules: [],
