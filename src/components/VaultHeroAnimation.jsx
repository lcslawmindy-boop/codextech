          ...
          return (
            <div
              ...
              style={{
                ...
                left: '50%',
                top: '50%',
                marginLeft: `${type === 'logo' ? -40 : (isEmoji ? -36 : -28)}px`,
                marginTop: `${type === 'logo' ? -40 : (isEmoji ? -36 : -24)}px`,
              ...
              {(type === 'logo' || type === 'flag') ? (
                ...
                <button
                  ...
                  style={{
                    ...
                    background: 'none',
                    color: color,
                    fontSize: isEmoji ? '64px' : '26px',
                    fontWeight: 'bold',
                    whiteSpace: 'nowrap',
                    textShadow: isEmoji ? 'none' : `0 0 12px ${color}, 0 0 24px ${glowColor}`,
