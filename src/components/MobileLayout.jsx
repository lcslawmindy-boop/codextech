  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="fixed z-[100] bg-gray-800/90 hover:bg-gray-700 border border-gray-600 rounded-full shadow-xl backdrop-blur-sm flex items-center gap-2 text-gray-300 text-xs font-semibold transition-all px-3 py-2"
        style={{ bottom: hideTab ? '4.5rem' : '9rem', right: '1rem' }}
        title="Search (⌘K)"
      >
