...
export default function ZatLogoWatermark() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9990] pointer-events-none flex flex-col items-center gap-2">
      ...
      />
      <div className="font-black text-cyan-400 tracking-widest text-center opacity-75 whitespace-nowrap" style={{ fontSize: '14px', textShadow: '0 0 8px rgba(0, 220, 255, 0.6)', lineHeight: '1.2', letterSpacing: '2px' }}>
        T.E.C.H.
      </div>
